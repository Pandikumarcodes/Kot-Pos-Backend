...
const getInventory = async (req, res, next) => {
  try {
    ...
    forwardError(next, err, "Failed to fetch inventory");
  }
};
...
const createInventory = async (req, res, next) => {
  try {
    ...
    forwardError(next, err, "Failed to create inventory item");
  }
};
...
const updateInventory = async (req, res, next) => {
  try {
    ...
    forwardError(next, err, "Failed to update inventory item");
  }
};
...
const restockItem = async (req, res, next) => {
  try {
    ...
    forwardError(next, err, "Failed to restock inventory item");
  }
};
...
const adjustStock = async (req, res, next) => {
  try {
    ...
    forwardError(next, err, "Failed to adjust inventory stock");
  }
};
